...
if __name__ == "__main__":
    ...
    # read weight
    with open('rnn_weight.pkl', 'rb') as f:
        rnn_wgt = pickle.load(f)
    ...
    for n in range(0, node_num):
        ...
        node_tmp.set_conv(xin=0,yin=0,xstart=0,ystart=0,xout=28,yout=28,zout=n,xk=0,yk=0,pad=0,stride=2) #TODO
        node_tmp.set_dst_mem(dst_node_x=0,dst_node_y=0,dst_node_number=32)
    ...
    for n in range(0, node_num):
        ...
        node_tmp.set_neu_par(spike_code='LIF',reset=reset,vth=vth,leak=leak)
        node_tmp.set_neu_num(neu_num=neu_num)
        node_tmp.set_conv(xin=28,yin=28,xstart=0,ystart=0,xout=13,yout=13,zout=n,xk=4,yk=4,pad=0,stride=2) #TODO
        node_tmp.set_wgt_mem(weight_list=rnn_wgt[0][n])
        node_tmp.set_dst_mem(dst_node_x=0,dst_node_y=1,dst_node_number=32)
        node_list.append(node_tmp)
    ...
    for n in range(0, node_num):
        ...
        node_tmp.set_neu_par(spike_code='LIF',reset=reset,vth=vth,leak=leak)
        node_tmp.set_neu_num(neu_num=neu_num)
        node_tmp.set_conv(xin=13,yin=13,xstart=0,ystart=0,xout=13,yout=13,zout=n,xk=1,yk=1,pad=0,stride=1)
        node_tmp.set_wgt_mem(weight_list=rnn_wgt[1][n])
        node_tmp.set_dst_mem(dst_node_x=1,dst_node_y=1,dst_node_number=10)
        node_list.append(node_tmp)
    ...
    for n in range(0, node_num):
        ...
        node_tmp.set_neu_par(spike_code='LIF',reset=reset,vth=vth,leak=leak)
        node_tmp.set_neu_num(neu_num=neu_num)
        node_tmp.set_conv(xin=13,yin=13,xstart=0,ystart=0,xout=1,yout=1,zout=n,xk=13,yk=13,pad=0,stride=1)
        node_tmp.set_wgt_mem(weight_list=rnn_wgt[2][n])
    ...
    #       gen spk
    #---------------------
    with open('rnn_fm.pkl', 'rb') as f:
        rnn_fm = pickle.load(f)
