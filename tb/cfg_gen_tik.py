...
if __name__ == "__main__":
    ...
    for x in range(4):
        for y in range(4):
            ...
            node_tmp.set_conv(xin=0,yin=0,xstart=64*x,ystart=64*y,xout=255,yout=255,zout=0,xk=0,yk=0,pad=0,stride=4) #TODO
    ...
    #       gen spk
    #---------------------
    track_fm = [[3 for i in range(255)] for j in range(255)]
